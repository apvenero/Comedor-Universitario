...
<form:form modelAttribute="menu" class="form-horizontal" action="guardarMenu" method="POST">
		...
		<fieldset>
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="textinput">Nombre Menú:</label>
				<div class="col-md-4">
					<form:input path="nombre" type="text" placeholder="Ingrese el nombre del Menu" class="form-control input-md" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<select id="vegetariano" name="vegetariano" class="form-control">
