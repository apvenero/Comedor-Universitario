...
<form:form modelAttribute="bebida" class="form-horizontal" action="guardarBebida" method="POST">
		<fieldset>
			<!-- Form Name -->
			<legend>Agregar Bebida</legend>
		</fieldset>
			<div class="form-group">
				<label class="col-md-4 control-label" for="textinput">Nombre Bebida:</label>
				<div class="col-md-4">
					<form:input path="nombre" type="text" placeholder="Ingrese el nombre del la bebida" class="form-control input-md" />
				</div>
			</div>
			<div class="form-group">
