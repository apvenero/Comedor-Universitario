...
<div class="container">
	<form class="form-horizontal">
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="total" value="$30" name="total" class="input-file" type="text">
				</div>
			</div>
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="radios">DNI del usuario</label>
					<div class="col-md-4">
					<input id="dni" value="33713210" name="dni" class="form-control input-md" type="text">
				</div>
			</div>
	...
	<a href="registrodePagos.html"><button type="button" id="bot" class="btn btn-danger">Volver</button></a>
