...
<form:form modelAttribute="entradaPlatoPrincipal" class="form-horizontal" action="guardarEntradaPP" method="POST">
		<fieldset>
			<!-- Form Name -->
			<legend>Agregar Entrada/Plato Principal </legend>
		</fieldset>
			<div class="form-group">
				<label class="col-md-4 control-label" for="textinput">Nombre:</label>
				<div class="col-md-4">
					<form:input path="nombre" type="text" placeholder="Ingrese el nombre" class="form-control input-md" />
				</div>
			</div>
			<div class="form-group">
